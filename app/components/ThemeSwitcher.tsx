...
import { SunFilledIcon } from "./icons/sun";
import { MoonFilledIcon } from "./icons/moon-filled";
import {trackEvent} from "@/app/docs/utils/va";
...
export const ThemeSwitch: FC<ThemeSwitchProps> = ({className, classNames}) => {
  ...
  const {Component, slots, getBaseProps, getInputProps, getWrapperProps, isSelected} = useSwitch({
